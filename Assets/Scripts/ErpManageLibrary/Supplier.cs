...
namespace ErpManageLibrary
{
  ...
  //          strSql.Append("Guid,Name,SimpName,LinkMan,Telephone,Fax,Address,Zip,Remark,ProduceType,IsEnable");
		//	strSql.Append(")");
  ...
  //          strSql.Append("ProduceType='" + ProduceType + "',");
