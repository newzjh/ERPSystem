...
public class frmSingleStockInOrder : BasePanel
{
    ...
    private string tablename = "StockSingleInOrder";
    ...
    private void LoadBills()
    {
        ...
        string selectedstorage = storages[currentstorage];
        var query1 = connection.Table<StockInOrderDetail>();
        var query2 = connection.Table<StockInOrder>().Where(_ => _.InStorage == selectedstorage).ToList();
    ...
    public void EditBill()
    {
        ...
        so.InStorage = storages[currentstorage];
        so.BatchNO = if6.text;
    ...
    private void NewBillExe()
    {
        ...
        stockinOrder.InStorage = storages[currentstorage];
